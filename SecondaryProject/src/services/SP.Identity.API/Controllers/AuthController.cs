...
namespace SP.Identity.API.Controllers
{
    ...
    public class AuthController : BaseController
    {
        ...
        public async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            var Token = GetEncodedToken(identityClaims);

            return GetUserTokenResponse(Token, claims, user);
        }
        ...
        private UsuarioRespostaLogin GetUserTokenResponse(string encoded, IList<Claim> claims, IdentityUser User)
        {
